...
We also provide [Docker](https://www.docker.com/) to
...
Assuming you are at the root of this source tree, type the command below to
build a docker image named `assassyn:latest` with all the dependencies installed.
