...
includes its data payload, and associated methods to write. Arrays whose owner is
`MemoryOwner(memory=DRAM, role="payload")` are skipped during this pass because they are modelled
