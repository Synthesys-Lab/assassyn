...
- [`internal/`](./internal/): The internal implementations of Assassyn.
  - [`simulation-coverage.md`](./internal/simulation-coverage.md): Source-level semantic coverage emitted by the Rust simulator.
  - [`translation-validation.md`](./internal/translation-validation.md): Normalized cycle semantics and RTL translation-validation artifacts.
