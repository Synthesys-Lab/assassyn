...
rm -f $REPO_PATH/python/assassyn/create_pb2.py
protoc --python_out=$REPO_PATH/python/assassyn --proto_path=$REPO_PATH/python/assassyn $REPO_PATH/python/assassyn/create.proto
